...
pub struct DLDevice {
    ...
    pub device_type: DLDeviceType::Type,
    #[doc = " \\brief The device index.\n For vanilla CPU memory, pinned memory, or managed memory, this is set to 0."]
    pub device_id: i32,
}
pub mod DLDataTypeCode {
    #[doc = " \\brief The type code options DLDataType."]
    pub type Type = ::std::os::raw::c_uint;
    #[doc = " \\brief signed integer"]
    pub const kDLInt: Type = 0;
    #[doc = " \\brief unsigned integer"]
    pub const kDLUInt: Type = 1;
    #[doc = " \\brief IEEE floating point"]
    pub const kDLFloat: Type = 2;
    #[doc = " \\brief Opaque handle type, reserved for testing purposes.\n Frameworks need to agree on the handle data type for the exchange to be well-defined."]
    pub const kDLOpaqueHandle: Type = 3;
    #[doc = " \\brief bfloat16"]
    pub const kDLBfloat: Type = 4;
    #[doc = " \\brief complex number\n (C/C++/Python layout: compact struct per complex number)"]
    pub const kDLComplex: Type = 5;
    #[doc = " \\brief boolean"]
    pub const kDLBool: Type = 6;
    #[doc = " \\brief FP8 data types"]
    pub const kDLFloat8_e3m4: Type = 7;
    #[doc = " \\brief FP8 data types"]
    pub const kDLFloat8_e4m3: Type = 8;
    #[doc = " \\brief FP8 data types"]
    pub const kDLFloat8_e4m3b11fnuz: Type = 9;
    #[doc = " \\brief FP8 data types"]
    pub const kDLFloat8_e4m3fn: Type = 10;
    #[doc = " \\brief FP8 data types"]
    pub const kDLFloat8_e4m3fnuz: Type = 11;
    #[doc = " \\brief FP8 data types"]
    pub const kDLFloat8_e5m2: Type = 12;
    #[doc = " \\brief FP8 data types"]
    pub const kDLFloat8_e5m2fnuz: Type = 13;
    #[doc = " \\brief FP8 data types"]
    pub const kDLFloat8_e8m0fnu: Type = 14;
